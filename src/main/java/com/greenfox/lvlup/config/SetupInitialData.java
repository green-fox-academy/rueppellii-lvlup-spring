...
public class SetupInitialData implements CommandLineRunner {
  ...
  @Autowired
  public SetupInitialData(ArchetypeRepository archetypeRepository, BadgeRepository badgeRepository, BadgeLevelRepository levelRepository, UserRepository userRepository, PitchRepository pitchRepository) {
  ...
  public void run(String... args) throws Exception {
    ...
    Review review1 = new Review("Yes, you are able to speak english", true);
    Review review2 = new Review("No", false);
    List<Review> reviewList = Arrays.asList(review1, review2);
    BadgeLevel level1 = new BadgeLevel(1, "I can reliably improve processes across the organization.", badge1, user1, user2, user3, user4, user6);
    levelRepository.save(level1);
    Pitch pitch1 = new Pitch(new Date(), 2,3, "I improved in English, pls give me more money",
        user2,level1,badge1,reviewList);
