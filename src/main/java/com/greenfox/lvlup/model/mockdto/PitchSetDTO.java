...
public class PitchSetDTO {
  ...
  public PitchSetDTO() {
    ...
    PitchDTO pitch2  = new PitchDTO("2018-11-29 17:10:47", "berei.daniel", "English speaker", 2, 3, "I was working abroad for six years, so I can speak english very well. Pls improve my badge badgeLevel to 3.");
